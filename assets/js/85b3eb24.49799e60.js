"use strict";
(self["webpackChunkmy_website"] = self["webpackChunkmy_website"] || []).push([[3856],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_commands_llm_locally_md_85b_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-commands-llm-locally-md-85b.json
const site_docs_commands_llm_locally_md_85b_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"commands/LLM Locally","title":"LLM Locally","description":"To put an LLM locally (which works similar to ChatGPT) we need two components - Ollama and Open WebUI. In this process we need to use both Ollama and Open WebUI, that is why I made a separate file for detailing the process of making LLM work locally.","source":"@site/docs/commands/LLM_Locally.md","sourceDirName":"commands","slug":"/commands/LLM Locally","permalink":"/docs/commands/LLM Locally","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"LLM Locally","title":"LLM Locally","sidebar_label":"LLM Locally"},"sidebar":"tutorialSidebar","previous":{"title":"Jupyter Notebook","permalink":"/docs/commands/Jupyter_Notebook"},"next":{"title":"Lightning Fast","permalink":"/docs/commands/Lightning Fast"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(4848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(8453);
;// ./docs/commands/LLM_Locally.md
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "To put an LLM locally (which works similar to ChatGPT) we need two components - Ollama and Open WebUI. In this process we need to use both Ollama and Open WebUI, that is why I made a separate file for detailing the process of making LLM work locally."
    }), "\n", (0,jsx_runtime.jsxs)(_components.blockquote, {
      children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
        children: "Ollama manages the downloading, loading/unloading, deleting, making new models and more of LLMs gracefully."
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsxs)(_components.blockquote, {
      children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
        children: "Open WebUI is the user interface similar to ChatGPT but with much more features hidden inside."
      }), "\n"]
