...
const site_docs_commands_rsync_md_fce_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"commands/Rsync","title":"Rsync","description":"Rsync and Parallel to copy files lightning fast (two steps/commands)","source":"@site/docs/commands/Rsync.md","sourceDirName":"commands","slug":"/commands/Rsync","permalink":"/docs/commands/Rsync","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"Rsync","title":"Rsync","sidebar_label":"Rsync"},"sidebar":"tutorialSidebar","previous":{"title":"PyTorch","permalink":"/docs/commands/PyTorch"},"next":{"title":"Secure Copy (SCP)","permalink":"/docs/commands/Secure Copy"}}');
...
const toc = [{
  "value": "Rsync and Parallel to copy files lightning fast (two steps/commands)",
  "id": "rsync-and-parallel-to-copy-files-lightning-fast-two-stepscommands",
  "level": 3
}, {
  "value": "Steps",
  "id": "steps",
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.h3, {
      id: "rsync-and-parallel-to-copy-files-lightning-fast-two-stepscommands",
      children: "Rsync and Parallel to copy files lightning fast (two steps/commands)"
